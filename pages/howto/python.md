...
- I cannot connect to a Jupyter kernel I created from a virtual environment!
    - You probably used the system python to build the environment.  You must load the python module first as per the [CCR Python in a virtual environment documentation](#using-virtual-environments).  You will have to delete the environment and kernel and rebuild both once you have run `module load gcc python`
