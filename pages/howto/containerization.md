...
### Setting up Paths
Images generated by Apptainer can be _large_. It is common for singularity containers to exceed 10gb. This means you can easily exceed your 10gb home directory quota while pulling a single container! You may also see error messages when pulling containers from remote repositories mentioning how `/tmp` does not have write permissions. All of these problems and more can be avoided by setting a few environmental variables before pulling apptainer containers:
