...
Alternatively, you can set the cache directory to your job's Slurm temporary directory which gets set to `/scratch/$JOBID` and is automatically deleted when your job ends.  
...
(venv) Apptainer> pip install imageio
