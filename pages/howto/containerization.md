...
This example shows how to run the ubuntu container bind mounting your group's project space to `/mnt/projects` and exposing your unix groups to the container:
