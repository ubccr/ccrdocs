...
**Date of downtime:** 7am Wednesday, September 3 - Thursday, September 4

**Approximate time of outage:** Beginning at 7am Wednesday, September 3 we will shut down affected servers and services.  As soon as electrical work is completed, CCR staff will return the HPC infrastructure to production.  Rack relocations #2 and #3 of the [data center move](https://www.buffalo.edu/ccr/support/research_facilities/ccrexpansion.html) will take place during this time period.  
...
- There will be very limited availability of CCR HPC infrastructure during this time.  Compute nodes that have been relocated to the new data center will be available for jobs.  
