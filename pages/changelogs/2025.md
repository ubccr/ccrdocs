...
## December 2025 Downtime

**Date of downtime:** Tuesday, December 30, 2025

This downtime has been cancelled.  
...
**What will be done:**
 ...
 - Updates of front-end login nodes (`login1`, `login2`, `vortex-future`)
 - Infrastructure Updates
 - Documentation updates to be published: Update to [CCR's software policy](../policies/software.md), [new information on the "R" Statistical package](../software/modules.md#r-the-statistical-computing-and-graphics-application) for software release ccrsoft/2024.04, additional information on using [QOS (Quality of Service) values](../hpc/jobs.md#slurm-directives-partitions-qos) for clarification, added a "change logs" section to our documentation site  which includes [downtime announcements](../changelogs/downtime-schedule.md).  All future announcements will be in the documentation.
 ...
 - Release of new "Using Python at CCR" course in UB Learns.  Self-register on the [UB Learns websit websitee](https://ublearns.buffalo.edu/d2l/le/discovery/view/course/288741)  
...
**What will be done:**
 ...
 - Default software release on `vortex-future` changing to `ccrsoft/2024.04` - you can pin your account to a specific software release, following the "Pin to a specific release" section of [CCR's Software Environment Documentation](../software/releases.md)
 - Updated [container documentation](../howto/containerization.md) to be published today
 - See [the January section below](#january---special-update) for special update
...
You can pin your account to a specific release follow the "Pin to a specific release" section of [CCR's Software Environment Documentation](../software/releases.md)

in the green box on [this page](https://docs.ccr.buffalo.edu/en/latest/software/releases/) 
...
For instructions on how to use the scavenger partitions, please refer to [CCR's job scavenger documentation](../hpc/jobs.md#scavenging-idle-cycles). 

For a full list of specs for the equipment in the UB-HPC academic partitions, see [CCR's "ub-hpc" cluster hardware documentation](https://www.buffalo.edu/ccr/support/research_facilities/ub-hpc/academic-hardware-specs.html).

For the industry partitions (and ub-hpc scavenger partition), see [CCR's "faculty" cluster hardware documentation](https://www.buffalo.edu/ccr/support/research_facilities/industry_cluster.html).

  
### Intro to CCR Course 
A new course was published in UB Learns for the Fall 2024 semester to provide new users with background information on how to effectively and efficiently use CCR's HPC resources.  The course was updated based on student feedback and republished for the Spring 2025 semester.  All students taking a course that uses CCR are required to complete the Intro to CCR course first and provide their instructor with a certificate of completion before getting access to their course's allocations.  Anyone using CCR for research purposes is highly encouraged to check out the course. You can self-enroll on the [UB Learns website](https://ublearns.buffalo.edu/d2l/le/discovery/view/course/285151).  
