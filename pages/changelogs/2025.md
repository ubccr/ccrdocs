...
**Date of downtime:** Friday 8/8/25 through Monday 8/11/25

**Approximate time of outage:** Beginning Friday morning, 8/8 we will shut down affected servers and services.  Beginning Monday morning, 8/11 we will bring the majority of the servers and services back online.  Phase 1 of the [data center move](https://www.buffalo.edu/ccr/support/research_facilities/ccrexpansion.html) will begin at this time so some racks of compute nodes will be offline longer.  

**Resources affected by power outage:**
...
**Specific Effects to CCR users:**  
No available HPC resources for the duration of this outage
