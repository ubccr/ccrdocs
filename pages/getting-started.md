...
- If you're an **experienced HPC user** and ready to log onto a cluster, you probably want to know:
     ...
     - What [software is available](software/modules.md) and how [software environment modules](software/modules.md) work  
